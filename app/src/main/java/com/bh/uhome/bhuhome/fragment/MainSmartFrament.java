...
//                initView();
    ...
    private void setHomeMenuData(){
        ...
        homeMenuAdapter = new GalleryGoodsAdapter(mActivity, SmartFragmentData.getHomeMenuData(), new GalleryGoodsAdapter.OnRecyclerViewItemClickListener() {
...
//        }
    ...
    private void initTitleBar() {
        mPortraitTitleBar = (TitleBar) parentView.findViewById(R.id.title_bar_portrait);
        ...
        mLandscapeTitleBar = (TitleBar) parentView.findViewById(R.id.title_bar_landscape);
        ...
        mFullScreenTitleBarBackBtn = new CheckTextButton(getActivity());
    ...
    private void initRealPlayPageLy() {
        mRealPlayPageLy = (LinearLayout) parentView.findViewById(R.id.realplay_page_ly);
        /** 测量状态栏高度 **/
    ...
    private void initView() {
        ...
        mRealPlayPlayRl = (RelativeLayout) parentView.findViewById(R.id.realplay_play_rl);
        ...
        mRealPlayPromptRl = (RelativeLayout) parentView.findViewById(R.id.realplay_prompt_rl);
        mRealPlayControlRl = (LinearLayout) parentView.findViewById(R.id.realplay_control_rl);
        mRealPlayBtn = (ImageButton) parentView.findViewById(R.id.realplay_play_btn);
        mRealPlaySoundBtn = (ImageButton) parentView.findViewById(R.id.realplay_sound_btn);
        mRealPlayFlowTv = (TextView) parentView.findViewById(R.id.realplay_flow_tv);
        mRealPlayFlowTv.setText("0k/s");

        mRealPlayCaptureRl = (RelativeLayout) parentView.findViewById(R.id.realplay_capture_rl);
        mRealPlayCaptureRlLp = (LayoutParams) mRealPlayCaptureRl.getLayoutParams();
        mRealPlayCaptureIv = (ImageView) parentView.findViewById(R.id.realplay_capture_iv);
        mRealPlayCaptureWatermarkIv = (ImageView) parentView.findViewById(R.id.realplay_capture_watermark_iv);
        mRealPlayRecordLy = (LinearLayout) parentView.findViewById(R.id.realplay_record_ly);
        mRealPlayRecordIv = (ImageView) parentView.findViewById(R.id.realplay_record_iv);
        mRealPlayRecordTv = (TextView) parentView.findViewById(R.id.realplay_record_tv);

        mRealPlayQualityBtn = (Button) parentView.findViewById(R.id.realplay_quality_btn);

        mRealPlayFullFlowLy = (LinearLayout) parentView.findViewById(R.id.realplay_full_flow_ly);
        mRealPlayFullRateTv = (TextView) parentView.findViewById(R.id.realplay_full_rate_tv);
        mRealPlayFullFlowTv = (TextView) parentView.findViewById(R.id.realplay_full_flow_tv);
        mRealPlayRatioTv = (TextView) parentView.findViewById(R.id.realplay_ratio_tv);
        mRealPlayFullRateTv.setText("0k/s");
        mRealPlayFullFlowTv.setText("0MB");

        mFullscreenButton = (CheckTextButton) parentView.findViewById(R.id.fullscreen_button);
        mFullscreenFullButton = (CheckTextButton) parentView.findViewById(R.id.fullscreen_full_button);
...
//            mRealPlayRecordContainerLy.setVisibility(View.VISIBLE);
    ...
    private void initOperateBarUI(boolean bigScreen) {
        ...
        if (bigScreen) {
            parentView.findViewById(R.id.ezopen_realplay_operate_bar).setVisibility(View.GONE);
        } else {
        }
    }
    ...
    private void initFullOperateBarUI() {
        mRealPlayFullOperateBar = (RelativeLayout) parentView.findViewById(R.id.realplay_full_operate_bar);
        mRealPlayFullPlayBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_play_btn);
        mRealPlayFullSoundBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_sound_btn);
        mRealPlayFullTalkBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_talk_btn);
        mRealPlayFullCaptureBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_previously_btn);
        mRealPlayFullPtzBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_ptz_btn);
        mRealPlayFullRecordContainer = parentView.findViewById(R.id.realplay_full_video_container);
        mRealPlayFullRecordBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_video_btn);
        mRealPlayFullRecordStartBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_video_start_btn);
        mRealPlayFullOperateBar.setOnTouchListener(this);

        mRealPlayFullPtzAnimBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_ptz_anim_btn);
        mRealPlayFullPtzPromptIv = (ImageView) parentView.findViewById(R.id.realplay_full_ptz_prompt_iv);

        mRealPlayFullTalkAnimBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_talk_anim_btn);

        mRealPlayFullAnimBtn = (ImageButton) parentView.findViewById(R.id.realplay_full_anim_btn);
    }
            ...
            if (mRealPlayFullTalkAnimBtn != null) {
                ...
                mRealPlayFullOperateBar.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mEndXy[0] = Utils.dip2px(getActivity(), 20);
                        mEndXy[1] = mStartXy[1];
...
//            case R.id.realplay_video_start_btn:
    ...
    private void startVoiceTalk() {
        ...
        Utils.showToast(getActivity(), R.string.start_voice_talk);
//        mRealPlayTalkBtn.setEnabled(false);
        ...
        if (mOrientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            startFullBtnAnim(mRealPlayFullAnimBtn, mStartXy, mEndXy, new AnimationListener() {
                ...
                @Override
                public void onAnimationEnd(Animation animation) {
                    Utils.showToast(getActivity(), R.string.realplay_full_talk_start_tip);
                    mRealPlayFullTalkAnimBtn.setVisibility(View.VISIBLE);
                    mRealPlayFullAnimBtn.setVisibility(View.GONE);
                    onRealPlaySvClick();
                    //                    mFullscreenFullButton.setVisibility(View.VISIBLE);
    ...
    private void ptzOption(final EZPTZCommand command, final EZPTZAction action) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ptz_result = AppApplication.getOpenSDK().controlPTZ(mCameraInfo.getDeviceSerial(), mCameraInfo.getCameraNo(), command,
    ...
    private void openQualityPopupWindow(View anchor) {
        ...
        height = Utils.dip2px(getActivity(), height);
        ...
        try {
            mQualityPopupWindow.showAsDropDown(anchor, -Utils.dip2px(getActivity(), 5),
                    -(height + anchor.getHeight() + Utils.dip2px(getActivity(), 8)));
        } catch (Exception e) {
            e.printStackTrace();
            closeQualityPopupWindow();
        }
                ...
                public void run() {
                    ...
                    if (bmp != null) {
                        try {
                            ...
                            MediaScanner mMediaScanner = new MediaScanner(getActivity());
                            mMediaScanner.scanFile(path, "jpg");
                            getActivity().runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(getActivity(), getResources().getString(R.string.already_saved_to_volume)+path, Toast.LENGTH_SHORT).show();
                                }
                            });
...
//            mRealPlayPtzBtn.setEnabled(false);
    ...
    private void handlePtzControlFail(Message msg) {
        ...
        switch (msg.arg1) {
            case ErrorCode.ERROR_CAS_PTZ_CONTROL_CALLING_PRESET_FAILED:// 正在调用预置点，键控动作无效
                Utils.showToast(getActivity(), R.string.camera_lens_too_busy, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_PRESETING_FAILE:// 当前正在调用预置点
                Utils.showToast(getActivity(), R.string.ptz_is_preseting, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_CONTROL_TIMEOUT_CRUISE_TRACK_FAILED:// 键控动作超时(当前正在轨迹巡航)
                Utils.showToast(getActivity(), R.string.ptz_control_timeout_cruise_track_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_INVALID_POSITION_FAILED:// 当前预置点信息无效
                Utils.showToast(getActivity(), R.string.ptz_preset_invalid_position_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_CURRENT_POSITION_FAILED:// 该预置点已是当前位置
                Utils.showToast(getActivity(), R.string.ptz_preset_current_position_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRESET_SOUND_LOCALIZATION_FAILED:// 设备正在响应本次声源定位
                Utils.showToast(getActivity(), R.string.ptz_preset_sound_localization_failed, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_MIRRORING_FAILED:// 设备正在镜像操作（设备镜像要几秒钟，防止频繁镜像操作）
                Utils.showToast(getActivity(), R.string.ptz_operation_too_frequently, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_PRESET_EXCEED_MAXNUM_FAILED:// 当前预置点超过最大个数
                Utils.showToast(getActivity(), R.string.ptz_preset_exceed_maxnum_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_PRIVACYING_FAILED:// 设备处于隐私遮蔽状态（关闭了镜头，再去操作云台相关）
                Utils.showToast(getActivity(), R.string.ptz_privacying_failed, msg.arg1);
                break;
            case ErrorCode.ERROR_CAS_PTZ_TTSING_FAILED:// 设备处于语音对讲状态(区别以前的语音对讲错误码，云台单独列一个）
                Utils.showToast(getActivity(), R.string.ptz_mirroring_failed, msg.arg1);
                break;
            ...
            case ErrorCode.ERROR_CAS_PTZ_ROTATION_RIGHT_LIMIT_FAILED:// 设备云台旋转到达右限位
                ...
                break;
            default:
                Utils.showToast(getActivity(), R.string.ptz_operation_failed, msg.arg1);
                break;
        }
    }
    ...
    private void handleVoiceTalkFailed(ErrorInfo errorInfo) {
        ...
        switch (errorInfo.errorCode) {
            case ErrorCode.ERROR_TRANSF_DEVICE_TALKING:
                Utils.showToast(getActivity(), R.string.realplay_play_talkback_fail_ison);
                break;
            case ErrorCode.ERROR_TRANSF_DEVICE_PRIVACYON:
                Utils.showToast(getActivity(), R.string.realplay_play_talkback_fail_privacy);
                break;
            case ErrorCode.ERROR_TRANSF_DEVICE_OFFLINE:
                Utils.showToast(getActivity(), R.string.realplay_fail_device_not_exist);
                break;
            ...
            case ErrorCode.ERROR_TTS_HNADLE_TIMEOUT:
                Utils.showToast(getActivity(), R.string.realplay_play_talkback_request_timeout, errorInfo.errorCode);
                break;
            ...
            case ErrorCode.ERROR_CAS_AUDIO_SEND_ERROR:
                Utils.showToast(getActivity(), R.string.realplay_play_talkback_network_exception, errorInfo.errorCode);
                break;
            default:
                Utils.showToast(getActivity(), R.string.realplay_play_talkback_fail, errorInfo.errorCode);
                break;
        }
    }
    ...
    private void handleSetVedioModeFail(int errorCode) {
        ...
        Utils.showToast(getActivity(), R.string.realplay_set_vediomode_fail, errorCode);
    }
        ...
        if (mRealPlayCaptureRl.getVisibility() == View.VISIBLE) {
            if (mOrientation == Configuration.ORIENTATION_PORTRAIT) {
                if (mRealPlayControlRl.getVisibility() == View.VISIBLE) {
                    mRealPlayCaptureRlLp.setMargins(0, 0, 0, Utils.dip2px(getActivity(), 40));
                } else {
                ...
                LayoutParams realPlayCaptureRlLp = new LayoutParams(
                        Utils.dip2px(getActivity(), 65), Utils.dip2px(getActivity(), 45));
...
//                SecureValidate.secureValidateDialog(this, this);
            ...
            default:
                txt = Utils.getErrorTip(getActivity(), R.string.realplay_play_fail, errorCode);
                break;
        }
    ...
    private void setPlayScaleUI(float scale, CustomRect oRect, CustomRect curRect) {
        if (scale == 1) {
            ...
            LayoutParams realPlayRatioTvLp = (LayoutParams) mRealPlayRatioTv
                    .getLayoutParams();
            if (mOrientation == Configuration.ORIENTATION_PORTRAIT) {
                realPlayRatioTvLp.setMargins(Utils.dip2px(getActivity(), 10), Utils.dip2px(getActivity(), 10), 0, 0);
            } else {
                realPlayRatioTvLp.setMargins(Utils.dip2px(getActivity(), 70), Utils.dip2px(getActivity(), 20), 0, 0);
            }
    ...
    private void initLoadingUI() {
        mRealPlayLoadingRl = (RelativeLayout) parentView.findViewById(R.id.realplay_loading_rl);
        mRealPlayTipTv = (TextView) parentView.findViewById(R.id.realplay_tip_tv);
        mRealPlayPlayIv = (ImageView) parentView.findViewById(R.id.realplay_play_iv);
        mRealPlayPlayLoading = (LoadingTextView) parentView.findViewById(R.id.realplay_loading);
        mRealPlayPlayPrivacyLy = (LinearLayout) parentView.findViewById(R.id.realplay_privacy_ly);

        // 设置点击图标的监听响应函数
        mRealPlayPlayIv.setOnClickListener(this);

        mPageAnimIv = (ImageView) parentView.findViewById(R.id.realplay_page_anim_iv);
    }
