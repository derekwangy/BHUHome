...
public class MallFragmentData {
    ...
    public static ArrayList<MallIndexInfo.DataBean.GoodsListBean> getgoodsList(){
        ...
        MallIndexInfo.DataBean.GoodsListBean bean8 = new MallIndexInfo.DataBean.GoodsListBean();
        bean8.setName("空调8");
        bean8.setPrice("340");
        bean8.setSource("品质优越，质量上乘，节能省电……");
        bean8.setLink("http://www.baidu.com");
        bean8.setMainPic("https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1504009716&di=b32c9a69f2f245f7f4d58746ce78777f&src=http://imgsrc.baidu.com/imgad/pic/item/9c16fdfaaf51f3de903def489eeef01f3a29790a.jpg");
        goodsList.add(bean8);

        MallIndexInfo.DataBean.GoodsListBean bean5 = new MallIndexInfo.DataBean.GoodsListBean();
        bean5.setName("格力空调5");
        bean5.setPrice("340");
        bean5.setSource("品质优越，质量上乘，节能省电……");
        bean5.setLink("http://www.baidu.com");
        bean5.setMainPic("https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1504009716&di=b32c9a69f2f245f7f4d58746ce78777f&src=http://imgsrc.baidu.com/imgad/pic/item/9c16fdfaaf51f3de903def489eeef01f3a29790a.jpg");
        goodsList.add(bean5);

        MallIndexInfo.DataBean.GoodsListBean bean6 = new MallIndexInfo.DataBean.GoodsListBean();
        bean6.setName("格力空调6");
        bean6.setPrice("340");
        bean6.setSource("品质优越，质量上乘，节能省电……");
        bean6.setLink("http://www.baidu.com");
        bean6.setMainPic("https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1504009716&di=b32c9a69f2f245f7f4d58746ce78777f&src=http://imgsrc.baidu.com/imgad/pic/item/9c16fdfaaf51f3de903def489eeef01f3a29790a.jpg");
        goodsList.add(bean6);

        MallIndexInfo.DataBean.GoodsListBean bean7 = new MallIndexInfo.DataBean.GoodsListBean();
        bean7.setName("格力空调7");
        bean7.setPrice("340");
        bean7.setSource("品质优越，质量上乘，节能省电……");
        bean7.setLink("http://www.baidu.com");
        bean7.setMainPic("https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1504009716&di=b32c9a69f2f245f7f4d58746ce78777f&src=http://imgsrc.baidu.com/imgad/pic/item/9c16fdfaaf51f3de903def489eeef01f3a29790a.jpg");
        goodsList.add(bean7);
        return goodsList;
    }


    public static ArrayList<MallIndexInfo.DataBean.RecommendTagsBean> getTabData() {
